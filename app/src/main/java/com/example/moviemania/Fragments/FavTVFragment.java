...
public class FavTVFragment extends Fragment {
    ...
    ArrayList<Films> favTVList=new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater,final ViewGroup container,
        ...
        progressBar=view.findViewById(R.id.favTVProgress);
        progressBar.setVisibility(View.VISIBLE);
        recyclerView=view.findViewById(R.id.favTVRecycle);
    ...
    public void getTv(final ViewGroup container){
        String url="https://api.themoviedb.org/3/account/"+ AccountDetails.ACC_ID+"/favorite/tv?api_key="+ AccountDetails.API_KEY +"&language=en-US&session_id="+AccountDetails.SESSION_ID+"&sort_by=created_at.asc&page=1";
        StringRequest stringRequest=new StringRequest(StringRequest.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    recyclerAdapter=new RecyclerAdapter(favTVList);
