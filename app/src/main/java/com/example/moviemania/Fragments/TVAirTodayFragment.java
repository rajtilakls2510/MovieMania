...
public class TVAirTodayFragment extends Fragment {

    RecyclerView recycleTv4;
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_tvair_today, container, false);
        recycleTv4=view.findViewById(R.id.recycleTv4);
        progressBar=view.findViewById(R.id.tvTodayProgress);
        progressBar.setVisibility(View.VISIBLE);
        getGenres(container, new GenreRetrieveCallback() {
            @Override
            public void retrieveGenres() {
                String url="https://api.themoviedb.org/3/tv/airing_today?api_key=8265bd1679663a7ea12ac168da84d2e8&language=en-US&page=1";
                StringRequest stringRequest=new StringRequest(StringRequest.Method.GET, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            recycleTv4.setLayoutManager(new LinearLayoutManager(getContext()));
                            recycleTv4.setAdapter(recyclerAdapter);
