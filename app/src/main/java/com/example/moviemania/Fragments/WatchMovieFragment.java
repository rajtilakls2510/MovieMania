...
public class WatchMovieFragment extends Fragment {
    ...
    ArrayList<Films> watchMovieList=new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater,final ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_watch_movie, container, false);
        progressBar=view.findViewById(R.id.watchMovieProgress);
        recyclerView=view.findViewById(R.id.watchMovieRecycle);
    ...
    public void getMovies(final ViewGroup container){
        String url="https://api.themoviedb.org/3/account/"+ AccountDetails.ACC_ID+"/watchlist/movies?api_key="+AccountDetails.API_KEY+"&language=en-US&session_id="+AccountDetails.SESSION_ID+"&sort_by=created_at.asc&page=1";
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for(int i=0;i<results.length();i++){
                        ...
                        watchMovieList.add(film1);
                    }
                    recyclerAdapter=new RecyclerAdapter(watchMovieList);
