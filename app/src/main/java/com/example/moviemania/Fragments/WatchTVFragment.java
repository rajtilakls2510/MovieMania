...
public class WatchTVFragment extends Fragment {
    ...
    ArrayList<Films> watchTvList=new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater,final ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_watch_tv, container, false);
        progressBar=view.findViewById(R.id.watchTvProgress);
        recyclerView=view.findViewById(R.id.watchTvRecycle);
    ...
    public void getTv(final ViewGroup container){
        String url="https://api.themoviedb.org/3/account/"+ AccountDetails.ACC_ID+"/watchlist/tv?api_key="+AccountDetails.API_KEY+"&language=en-US&session_id="+AccountDetails.SESSION_ID+"&sort_by=created_at.asc&page=1";
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for(int i=0;i<results.length();i++){
                        ...
                        watchTvList.add(film1);
                    }
                    recyclerAdapter=new RecyclerAdapter(watchTvList);
