...
public class TVTopRatedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_tvtop_rated, container, false);
        recycleTv1=view.findViewById(R.id.recycleTv1);
        progressBar=view.findViewById(R.id.tvTopProgress);
        progressBar.setVisibility(View.VISIBLE);
        getGenres(container, new GenreRetrieveCallback() {
            @Override
            public void retrieveGenres() {
                String url="https://api.themoviedb.org/3/tv/top_rated?api_key=8265bd1679663a7ea12ac168da84d2e8&language=en-US&page=1";
                StringRequest stringRequest=new StringRequest(StringRequest.Method.GET, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            recycleTv1.setLayoutManager(new LinearLayoutManager(getContext()));
                            recycleTv1.setAdapter(recyclerAdapter);
