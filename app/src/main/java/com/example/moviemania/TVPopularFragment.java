...
public class TVPopularFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_tvpopular, container, false);
        recycleTv2=view.findViewById(R.id.recycleTv2);
        progressBar=view.findViewById(R.id.tvPopularProgress);
        progressBar.setVisibility(View.VISIBLE);
        getGenres(container);
        String url="https://api.themoviedb.org/3/tv/popular?api_key=8265bd1679663a7ea12ac168da84d2e8&language=en-US&page=1";
        StringRequest stringRequest=new StringRequest(StringRequest.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    recycleTv2.setLayoutManager(new LinearLayoutManager(getContext()));
                    recycleTv2.setAdapter(recyclerAdapter);
