...
public class ReviewMovieFragment extends Fragment {
    ...
    ArrayList<Films> ReviewMovieList=new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar=view.findViewById(R.id.reviewMovieProgress);
        recyclerView=view.findViewById(R.id.reviewMovieRecycle);
    ...
    public void getMovies(final ViewGroup container){
        String url="https://api.themoviedb.org/3/account/"+AccountDetails.ACC_ID+"/rated/movies?api_key="+AccountDetails.API_KEY+"&language=en-US&session_id="+AccountDetails.SESSION_ID+"&sort_by=created_at.asc&page=1";
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for(int i=0;i<results.length();i++){
                        ...
                        ReviewMovieList.add(film1);
                    }
                    recyclerAdapter=new RecyclerAdapter(ReviewMovieList);
